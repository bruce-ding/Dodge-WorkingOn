...
namespace Particles2DPipelineParticle
{
    public class ParticleSystem : DrawableGameComponent
    {
        ...
        ParticleSystemSettingsList list = new ParticleSystemSettingsList();
            ...
            : base(game)
        {
            ...
            settings = list[settingsAssetName];
        ...
        protected override void LoadContent()
        {
            ...
            texture = Game.Content.Load<Texture2D>(Path.Combine("Particles2DPipelineParticle", settings.TextureFilename));
