...
namespace DodgeXaml.ScreenInput
{
    public class ScreenPad
    {
		...
		public ScreenPad(Game1 game, Texture2D pad, Texture2D thumb, Texture2D abxyButtons)
        {
            this.game = game;
        ...
        private void PlaceControls(bool xType)
        {
            ...
            yOffest = Game1.Current.ScreenSize.Y - padTexture.Height - 30;
