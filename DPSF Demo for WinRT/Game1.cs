...
namespace DPSF_Demo_for_WinRT
{
    ...
    public class Game1 : Game
    {
        ...
        DPSF.ParticleSystems.GasFallParticleSystem gasFallParticleSystem = null;
        ...
        protected override void Initialize()
        {
            ...
            gasFallParticleSystem = new DPSF.ParticleSystems.GasFallParticleSystem(null);
            ...
            particleSystemManager.AddParticleSystem(gasFallParticleSystem);
